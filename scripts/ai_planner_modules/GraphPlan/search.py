...
import ai_planner_modules.GraphPlan.util as util
...
def breadthFirstSearch(problem):
    ...
    def costFn(xxx_todo_changeme):
        (state, actions) = xxx_todo_changeme
        return len(actions)
    # use FIFO and graphSearch
...
def aStarSearch(problem, heuristic=nullHeuristic):
    def costFn(xxx_todo_changeme2):
        (state, actions) = xxx_todo_changeme2
